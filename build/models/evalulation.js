...
var Evaluation = /** @class */ (function () {
    function Evaluation() {
        ...
        this.to_serializable = function () {
            return {
                type: _this.type,
                formal_name: _this.formal_name,
                player_hand_size: _this.player_hand_size,
    ...
    Object.defineProperty(Evaluation.prototype, "hand_description", {
        get: function () {
            ...
            return "Best 5-card hand using ".concat(individual_count, " individual and ").concat(community_count, " community");
        },
        enumerable: false,
        configurable: true
    });
