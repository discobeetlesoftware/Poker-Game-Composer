...
var Database = /** @class */ (function () {
    function Database(rootDir, routePath) {
        ...
        this.schemaPath = function (gameName) {
            return path.join(__dirname, "..", "..", "games", "".concat(gameName, ".json"));
        };
        this.gamePath = function (game) {
            return path.join(__dirname, "..", "..", "games", "".concat(game.sanitized_name, ".json"));
        };
        ...
        this.hydrateGame = function (data, file) {
            ...
            var evaluation = _this.hydrateEvaluation(data.evaluation);
